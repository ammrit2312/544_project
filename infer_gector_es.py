"""
GECTOR inference for the Spanish-only model (xlm-roberta-base + es labels).
"""
...
encoder_name = ckpt.get('encoder_name', ENCODER)
model = GECTorModel(encoder_name, num_labels=len(labels)).to(device)
