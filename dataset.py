...
class GECDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Encode target (decoder input/output)
        ...
        tgt_ids    = tgt_enc['input_ids'].squeeze()   # [max_len]
        tgt_input  = tgt_ids[:-1]                     # decoder input  (drop last)
        tgt_output = tgt_ids[1:]                      # labels         (shift right)
