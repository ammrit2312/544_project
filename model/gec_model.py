...
class GECModel(nn.Module):
    ...
    def __init__(self, d_model=512, num_heads=8, d_ff=2048, num_layers=4, max_len=128, dropout=0.1, freeze_encoder: bool=True):
        super().__init__()
        ...
        self.decoder = Decoder(d_model=d_model, num_heads=num_heads, d_ff=d_ff, num_layers=num_layers, vocab_size=vocab_size, max_len=max_len, dropout=dropout)
