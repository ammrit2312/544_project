...
def download_english():
    ...
    df = df[['modified', 'sentence', 'transformation']].rename(columns={'modified': 'incorrect', 'sentence': 'correct', 'transformation': 'transformation'})
    df['lang'] = 'en'
    return df
...
def download_spanish():
    ...
    df = df[df['lang'] == 'es'][['modified', 'sentence', 'transformation']].rename(columns={'modified': 'incorrect', 'sentence': 'correct', 'transformation': 'transformation'})
    df['lang'] = 'es'
    return df
